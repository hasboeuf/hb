...
void HbClientAuthService::addStrategy(HbClientAuthStrategy* strategy) {
    if (strategy && !mStrategies.contains(strategy->type())) {
        connect(strategy,
                &HbClientAuthStrategy::authContractReady,
                this,
                &HbClientAuthService::onAuthContractReady,
                Qt::UniqueConnection);
        connect(strategy,
                &HbClientAuthStrategy::authContractFailed,
                this,
                &HbClientAuthService::onAuthContractFailed,
                Qt::UniqueConnection);
