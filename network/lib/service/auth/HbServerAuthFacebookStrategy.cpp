...
HbServerAuthFacebookStrategy::HbServerAuthFacebookStrategy() : HbServerOAuthStrategy() {
    connect(&mRequester,
            &HbFacebookRequester::requestCompleted,
            this,
            &HbServerAuthFacebookStrategy::onRequestCompleted,
            Qt::UniqueConnection);
}
...
bool HbServerAuthFacebookStrategy::checkLogin(const HbAuthRequestContract* contract) {
    ...
    connect(server_auth,
            ...
            this,
            &HbServerAuthFacebookStrategy::onLinkSucceed,
            Qt::UniqueConnection);
    connect(
        server_auth, &HbO2ServerFacebook::linkFailed, this, &HbServerOAuthStrategy::onLinkFailed, Qt::UniqueConnection);
