...
HbServicePresenceServerConfig::HbServicePresenceServerConfig() : HbServicePresenceConfig() {
...
bool HbServicePresenceServerConfig::isValid() const {
    ...
    if (mWarningAliveThreshold <= 0 || mKickAliveThreshold <= mWarningAliveThreshold) {
