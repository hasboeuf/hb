...
HbServiceAuthConfig::HbServiceAuthConfig() : HbServiceConfig() {
}

HbServiceAuthConfig::HbServiceAuthConfig(const HbServiceAuthConfig& config) : HbServiceConfig(config) {
    if (this != &config) {
    }
}
