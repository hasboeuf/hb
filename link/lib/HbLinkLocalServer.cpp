...
HbLinkLocalServer::HbLinkLocalServer(QObject* parent) : QTcpServer(parent) {
...
QHash<QString, QString> HbLinkLocalServer::parseResponse(QByteArray& data) {
    ...
    //    User-Agent: Mozilla/5.0 (Windows NT 10.0; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/48.0.2564.116
    //    Safari/537.36 Accept: */* Referer: http://localhost:8080/?code={CODE} Accept-Encoding: gzip, deflate, sdch
    ...
    //    User-Agent: Mozilla/5.0 (Windows NT 10.0; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/48.0.2564.116
    //    Safari/537.36 Accept-Encoding: gzip, deflate, sdch Accept-Language: fr-FR,fr;q=0.8,en-US;q=0.6,en;q=0.4
    //
    ...
    QRegExp capture_expr(
        "(/\\?\\S+)"); // Matches "/?" followed by non white-space characters => e.g.: "/?var1=foo&var2=bar"
